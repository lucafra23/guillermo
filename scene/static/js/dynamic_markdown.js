// Dynamic Markdown Editor Configuration for Django Unfold
// Uses EasyMDE with custom styling

window.initializeMarkdownEditors = function(container = document) {
    if (typeof EasyMDE === 'undefined') {
        console.warn("[DynamicMarkdown] EasyMDE is not defined. Deferring editor initialization.");
        return;
    }

    const markdownTextareas = container.querySelectorAll('textarea[id^="markdown-"], textarea[class*="markdown-editor"]');
